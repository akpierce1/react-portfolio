          ...
          <div class="container">
            ...
            >
              <div class="navbar-nav ms-auto">
                ...
                <a class="nav-item nav-link" href="#projects-section">
                  Projects
                </a>
                <a class="nav-item nav-link" href="#skills-section">
                  Skills
                </a>
                <a class="nav-item nav-link" href="#experience-section">
                  Experience
                </a>
              </div>
            </div>
